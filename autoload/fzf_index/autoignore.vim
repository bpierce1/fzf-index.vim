" =============================================================================
" File:          autoload/fzf_index/autoignore.vim
...
if exists('g:fzf_index_autoignore_loaded') && g:fzf_index_autoignore_loaded
		\ && !g:fzf_index_autoignore_debug
	finish
endif
let g:fzf_index_autoignore_loaded = 1

if !exists('g:fzf_index_autoignore_debug')
	let g:fzf_index_autoignore_debug = 0
endif

if !exists('g:fzf_index_autoignore_trace')
	let g:fzf_index_autoignore_trace = 0
endif
...
if !exists('g:fzf_index_custom_ignore')
	let g:fzf_index_custom_ignore = {}
endif
let g:fzf_index_custom_ignore['func'] = 'fzf_index#autoignore#ignore'
let g:fzf_index_custom_ignore['func-init'] = 'fzf_index#autoignore#ignore_init'
let g:fzf_index_custom_ignore['func-close'] = 'fzf_index#autoignore#ignore_close'

if !exists('g:fzf_index_root_markers')
	let g:fzf_index_root_markers = []
endif
call add(g:fzf_index_root_markers, '.fzf_indexignore')
...
function! s:trace(message) abort
    if g:fzf_index_autoignore_trace
        echom "fzf_index_autoignore: " . a:message
    endif
endfunction
...
function! s:load_project_patterns(root_dir) abort
	let l:ign_path = a:root_dir . '/.fzf_indexignore'
	...
	for line in l:lines
		...
		if len(l:matches) > 0
			...
			if index(l:knownsyntaxes, l:cursyntax) < 0
				echoerr "fzf_index_autoignore: Unknown syntax '".l:cursyntax."' in: ".l:ign_path
			endif
			continue
		endif
		" Patterns!
...
function! fzf_index#autoignore#ignore(item, type) abort
...
function! fzf_index#autoignore#ignore_init() abort
	let l:root = getcwd()
...
function! fzf_index#autoignore#ignore_close() abort
	if s:changed_wildignore
...
function! fzf_index#autoignore#get_patterns(root_dir) abort
