" =============================================================================
" File:          autoload/fzf_index/changes.vim
" Description:   Change list extension
" Author:        Kien Nguyen <github.com/kien>
" =============================================================================

" Init {{{1
if exists('g:loaded_fzf_index_changes') && g:loaded_fzf_index_changes
	fini
en
let g:loaded_fzf_index_changes = 1

cal add(g:fzf_index_ext_vars, {
	\ 'init': 'fzf_index#changes#init(s:bufnr, s:crbufnr)',
	\ 'accept': 'fzf_index#changes#accept',
	\ 'lname': 'changes',
	\ 'sname': 'chs',
	\ 'exit': 'fzf_index#changes#exit()',
	\ 'type': 'tabe',
	\ 'sort': 0,
	\ 'nolim': 1,
	\ })
...
endf
" Public {{{1
fu! fzf_index#changes#init(original_bufnr, bufnr)
	let bufnr = exists('s:bufnr') ? s:bufnr : a:bufnr
	let bufs = exists('s:clmode') && s:clmode ? fzf_index#buffers('id') : [bufnr]
...
fu! fzf_index#changes#accept(mode, str)
