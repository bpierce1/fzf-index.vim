" =============================================================================
" File:          autoload/fzf_index/undo.vim
" Description:   Undo extension
" Author:        Kien Nguyen <github.com/kien>
" =============================================================================

" Init {{{1
if ( exists('g:loaded_fzf_index_undo') && g:loaded_fzf_index_undo )
	fini
en
let g:loaded_fzf_index_undo = 1

cal add(g:fzf_index_ext_vars, {
	\ 'init': 'fzf_index#undo#init()',
	\ 'accept': 'fzf_index#undo#accept',
	\ 'lname': 'undo',
	\ 'sname': 'udo',
	\ 'enter': 'fzf_index#undo#enter()',
	\ 'exit': 'fzf_index#undo#exit()',
	\ 'type': 'line',
	\ 'sort': 0,
	\ 'nolim': 1,
	\ })
...
fu! s:syntax()
	...
	for [ke, va] in items({'T': 'Directory', 'Br': 'Comment', 'Nr': 'String',
		\ 'Sv': 'Comment', 'Po': 'Title'})
		cal fzf_index#hicheck('CtrlPUndo'.ke, va)
	endfo
...
fu! fzf_index#undo#accept(mode, str)
...
fu! fzf_index#undo#id()
	retu s:id
endf

fu! fzf_index#undo#enter()
	let s:undos = s:getundo()
endf

fu! fzf_index#undo#exit()
	unl! s:lines
endf
"}}}
